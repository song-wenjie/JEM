...
vad_option = sys.argv[4] # using fold 1,2,3,4,5 as test set, using the other sets as training and validation set
device = sys.argv[5]
...
for epoch in range(50):
    ...
    if score > history_score:
        history_score = score
        print('vad set: epoch ' + str(epoch) + ':accuracy:' + str(acc) + ';sensitivity:' + str(se) + ';specificity:' + str(sp) + ';score:' + str(score))
        ...
        sp = result[3][3] / (result[3][0] + result[3][1] + result[3][2] + result[3][3])
        score = (se + sp) / 2
        print('test set: epoch ' + str(epoch) + ':accuracy:' + str(acc) + ';sensitivity:' + str(se) + ';specificity:' + str(sp) + ';score:' + str(score))